...
export async function login(_prevState: LoginState, formData: FormData): Promise<LoginState> {
  ...
  // /dashboard is the real landing screen now — it redirects on to
  // /onboarding itself if this tenant hasn't finished the guided flow yet,
  // so this doesn't need to duplicate that check.
  redirect("/dashboard");
}
