...
export function ImportWizard() {
  ...
  return (
    <div className="flex w-full max-w-3xl flex-col gap-6">
      <ol data-tour="import-steps" className="flex flex-wrap gap-x-4 gap-y-1 text-sm text-muted-foreground">
      ...
      {step === "upload" && (
        <div data-tour="csv-upload" className="flex flex-col gap-4 rounded-lg border p-6">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="rounded-lg border p-6">
            <h2 className="mb-4 text-sm font-semibold">
              ...
              {warningCount > 0 && (
                // Solid pill, not plain gold text: gold at 2.4:1 on this
                // background fails WCAG AA (needs 4.5:1) — destructive
                // passes as plain text (5.15:1) so it's untouched above.
                <span className="ml-2 rounded-full bg-warning px-1.5 py-0.5 text-xs font-normal text-warning-foreground">
                    ...
                    <tr key={row.row_number} className="border-b last:border-0">
                      ...
                      <td className="py-1 pr-2">
                        {!row.valid ? (
                          ...
                          <span
                            className="rounded-full bg-warning px-1.5 py-0.5 text-warning-foreground"
